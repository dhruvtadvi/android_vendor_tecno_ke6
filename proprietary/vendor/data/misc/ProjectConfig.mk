...
#BSP:modify lcm driver CLBLEPUB-4 by baofu.zhang 20191202 start
BOOT_LOGO = hdplus1640
#BSP:modify lcm driver CLBLEPUB-4 by baofu.zhang 20191202 end
BUILD_AGO_GMS = yes
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
CUSTOM_BUILD_VERNO = CY-KE6-H6116-M
...
CUSTOM_HAL_IMGSENSOR = s5k3l6_mipi_raw s5k3l6ext2_mipi_raw gc8034_mipi_raw gc8034ext2_mipi_raw gc6153_serial_yuv ov2685_mipi_raw pblcs5k3l6_mipi_raw pblcs5k3l6ext2_mipi_raw pblcgc8034_mipi_raw pblcgc8034ext2_mipi_raw pblcgc6153_serial_yuv pblcov2685_mipi_raw
CUSTOM_TRAN_CAM_MATERIAL_CODE = s5k3l6_17201599 s5k3l6_17201625 gc8034_17201657 gc8034_17201636 gc6153_17201615 ov2685_17201659
CUSTOM_HAL_MAIN3_IMGSENSOR = gc6153_serial_yuv
CUSTOM_HAL_MAIN2_IMGSENSOR = ov2685_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l6_mipi_raw s5k3l6ext2_mipi_raw
TRAN_CAMERA_FAKE_STEREO_YUV_INDEX = 3
#ITD:modify by camera driver team end
#BSP: modify KELHLYYL-4 by tao.lan for 20200318 start
CUSTOM_HAL_MSENSORLIB =
#BSP: modify KELHLYYL-4 by tao.lan for 20200318 end
...
#BSP: modify KDLHLYAEE-2 by tao.lan 20191202 start
CUSTOM_KERNEL_SENSORHUB = yes
CUSTOM_KERNEL_BAROMETER = no
#BSP: modify KDLHLYAEE-2 by tao.lan 20191202 end
...
#BSP: modify KELHLYYL-4 by tao.lan for 20200318 end
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = s5k3l6_mipi_raw s5k3l6ext2_mipi_raw gc8034_mipi_raw gc8034ext2_mipi_raw gc6153_serial_yuv ov2685_mipi_raw
#ITD:modify by camera driver team end
...
#BSP: modify KELHLYYL-4 by tao.lan for 20200318 end
#ITD:modify by camera driver team start
CUSTOM_KERNEL_MAIN3_IMGSENSOR = gc6153_serial_yuv
CUSTOM_KERNEL_MAIN2_IMGSENSOR = ov2685_mipi_raw
...
#TSD: modify CLBLEPUB-2 by chaochao.he 20191204 start
CUSTOM_MODEM=ke6_h6116_m1
#TSD: modify CLBLEPUB-2 by chaochao.he 20191204 end
...
#SPD:modify aal KDLHLYAEE-8 by shuaishuai.ren 20191227start
MTK_AAL_SUPPORT = yes
#SPD:modify aal KDLHLYAEE-8 by shuaishuai.ren 20191227end
...
#BSP:modify audio bring up KDLHLYAEE-5 shuanglei.wang 20191204 start
MTK_AUDIO_NUMBER_OF_MIC = 1
#BSP:modify audio bring up KDLHLYAEE-5 shuanglei.wang 20191204 end
...
#BSP:modify audio param CLBLEPUB-250 shuanglei.wang 20191224 start
MTK_BESLOUDNESS_SUPPORT = yes
#BSP:modify audio param CLBLEPUB-250 shuanglei.wang 20191224 end
...
#ITD:add cam 3pty function by shoufeng.zhao 20191014 start
MTK_CAM_HDR_SUPPORT = no
#ITD:add cam 3pty function by shoufeng.zhao 20191014 end
...
#SDD: modify KDQHHLEYL-11 by jiangping.guo 20191104 start
MTK_CTA_SET = no
#SDD: modify KDQHHLEYL-11 by jiangping.guo 20191104 end
MTK_CTA_SUPPORT = no
MTK_CTM_SUPPORT = no
...
#BSP:modify factory config BLSLEPUB-4737 by wang.qin 20191204 start
#BSP:modify factory config BLSLEPUB-4737 by wang.qin 20191204 end
...
#TSD: modify CLBLEPUB-5 by tieshan.huang 20191206 start
MTK_FMRADIO_APP = yes
...
MTK_FM_SUPPORT = yes
#TSD: modify CLBLEPUB-5 by tieshan.huang 20191206 end
...
#TSD: modify TSDT-75 by chaochao.he 20200102 start
MTK_MULTIPLE_IMS_SUPPORT = 2
#TSD: modify TSDT-75 by chaochao.he 20200102 end
...
#SDD: modify KDQHHLEYL-11 by jiangping.guo 20191111 start
MTK_SIGNATURE_CUSTOMIZATION = yes
#SDD: modify KDQHHLEYL-11 by jiangping.guo 20191111 end
...
#TSD: modify KDLHLYYLHW-2 by chaochao.he 20200107 start
MTK_WFC_SUPPORT = yes
#TSD: modify KDLHLYYLHW-2 by chaochao.he 20200107 end
MTK_WFD_HDCP_TX_SUPPORT = no
MTK_WFD_SINK_SUPPORT = no
MTK_WFD_SINK_UIBC_SUPPORT = no
#TSD:modify CLBLEPUB-677 by tieshan.huang 20200106 start
MTK_WFD_SUPPORT = yes
#TSD:modify CLBLEPUB-677 by tieshan.huang 20200106 end
...
#BSP: add custom macro by wanghanfeng 20191016 start
CUSTOM_TRAN_PROJECT=tran_ke6
CUSTOM_TRAN_BOM=tran_ke6_m1
MTK_BUILD_VERNO=KE6-H6116MNO-QGo-GL-210727V418
TRAN_FINGERPRINT_BUILD_VERNO=MNO-GL-210727V418
...
TRAN_CAMERA_FORDUALCAM_IS_CROP = yes
#ITD:add cam 3pty function by shoufeng.zhao 20191014 end
#ITD:add flashlight control for CLBLEPUB-444 by desuo.lu 20191230 start
TRAN_FLASH_SLIDE_CONTROL = yes
#ITD:add flashlight control for CLBLEPUB-444 by desuo.lu 20191230 end
#ITD:add Dark complexion by desuo.lu 20191230 start
TRAN_CAM_SKIN_COMPATIBLE = yes
#ITD:add Dark complexion by desuo.lu 20191230 end
